// varianceP calculator in the result of stdDevP https://www.calculator.net/standard-deviation-calculator.html
topSuite("Ext.data.summary.VarianceP", ['Ext.data.Model', 'Ext.Number'], function() {
    var aggregator;

    beforeEach(function() {
        aggregator = new Ext.data.summary.VarianceP();
    });
    ...
    function makeSuite(withRecords) {
        ...
        describe("value", function() {
            ...
            it("should return the correct varianceP", function() {
                data = [10, 12, 23, 23, 16, 23, 21, 14];
                expect(run()).toBe(25.44);
            });

            it("should return the varianceP when there are duplicates", function() {
                data = [10, 12, 23, 23, 16, 23, 21, 14, 10, 12];
                expect(run()).toBe(27.84);
            });

            it("should return the varianceP correctly with negative numbers", function() {
                data = [-8, -11, -14, -4, -2, -17, -6, -9, -5, -12];
                expect(run()).toBe(20.16);
            });
        });
        ...
        describe("property", function() {
            ...
            it("should run on the correct property", function() {
                expect(run('p1')).toBe(40.09);
            });

            it("should run on another property", function() {
                expect(run('p2')).toBe(23.24);
            });
        });
